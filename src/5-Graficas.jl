...
# ╔═╡ ceee9b12-9b72-44c5-82db-56dd6e411ddb
using PlutoUI

# ╔═╡ 8e4357e7-e71e-4e5b-bc36-7b4d0fb176c9
using Plots

# ╔═╡ 0440055a-8be6-11ed-01f2-ebad3cb9e0e5
# html"""<style>
# main {
...
# ╔═╡ b2de0a6a-6465-4fc4-a9ca-f1381f639d53
md"""
...
# ╔═╡ 7439b8de-63e0-4c2a-b3bb-3e7035a09cf2
md"""
...
# ╔═╡ eca6d702-a0d4-43f1-b67d-d44f34e019f8
md"""
La documentación la podemos consultar en **https://docs.juliaplots.org/**
"""

# ╔═╡ e48f02d4-8bf5-47d6-a411-e500e292237a
md"""
...
# ╔═╡ 4b021942-c4dc-438b-958e-b5fd7f373d6e
gr()

# ╔═╡ 083a8c00-203a-411b-8025-b58848474461
md"""
...
# ╔═╡ ba20237d-0be7-4de2-a475-67510917321d
md"""
...
# ╔═╡ 999d1831-8a7d-4f51-abcb-7ca31ff91f9f
x = 0.0:0.01:2.0  # notemos que podemos hacer x = collect(0.0:0.01:2.0)

# ╔═╡ c4977435-1e45-4911-82c6-6fb17dd9e894
y = x.^2

# ╔═╡ 4ffdf11f-4b2b-4b6c-8f98-b25e4c61d11c
plot(x,y)

# ╔═╡ 7300f5c0-29be-4c89-883d-e7d7fb86edca
md"""
...
# ╔═╡ 87b90925-40b0-42bc-993e-f7693d68d222
plotattr(:Series); # Podemos ver los atributos de :Plot, :Subplot, :Axis;

# ╔═╡ e7d1ef6e-2335-4dd1-b9cf-ffa432ec8a91
plot(x, y, 
	color=:orange,
	linewidth=4,
	linestyle=:dash,
...
# ╔═╡ 55910fc1-c4bb-4cd7-9716-afac759746bd
md"""
...
# ╔═╡ 8339b07e-a8dc-48bc-b3e0-6a0b8f33e88d
y2 = sqrt.(x);  # Recordemos que y sigue en memoria con la función cuadrática 

# ╔═╡ 3c56abc2-ae3f-4ee0-9666-491b6b33480b
plot(x,y,
	label="Cuadrática");

# ╔═╡ e175fcec-11b9-4bf4-9f36-268f540fe8c8
plot!(x,y2,
	 label="raíz")

# ╔═╡ 9409e28b-7192-4d4c-a59b-5c386e7b5074
md"""
## 
"""

# ╔═╡ 264bd4da-ffdc-44d0-9651-ff7458f5faa7
x3 = -2:0.01:2

# ╔═╡ 9fabf361-e5c0-4db1-bb5b-440da35fe377
y3 = exp.(-x3.^2)

# ╔═╡ 6f69275a-0a5c-4aff-84b9-1dcc07a9a501
y4 = abs.(cos.(x3))

# ╔═╡ ccb934af-8dd6-424d-ae9f-4a69a308d363
begin
	p = plot();
	p = plot(x3,y3);
	p = plot!(x3,y4);
...
# ╔═╡ 0bfe92be-331d-4b75-bc8b-236bf93dca8f
plot(p)

# ╔═╡ 7aee58a4-edc3-45f9-adf5-fb5c45dcf3b3
md"""
## Gráficas tipo scatter y subplots
"""

# ╔═╡ 336129e4-e76c-4b5f-b583-5dfa816ba23f
x5 = rand(10)

# ╔═╡ 140bf72c-6dc7-4a2e-844f-814d76b42d47
y5 = rand(10)

# ╔═╡ e38a68a7-2351-4638-af22-e291f39a6cc5
p1 = scatter(x5,y5); # Poner ;  para ocultar la grafica

# ╔═╡ f4b03db7-1a9a-447a-8e9a-4371f2b490af
p2 = plot(x,y2);

# ╔═╡ 504dc3de-3620-46b0-965a-8fb3778170a4
plot(p1,p2,p,p1)

# ╔═╡ 8cd4e919-6d3f-47f6-9981-569ca1cbaefd
md"""
...
# ╔═╡ fab5ab74-b1af-4c3e-b3e5-bb43fa89a02e
begin
...
# ╔═╡ 6fc1dbdc-e38a-4dd3-9882-48abd8d6ba11
md"""
Tenemos las coordenadas $(x,y)$ en memoria.  Visualicemos la función.
"""

# ╔═╡ 06acb7e0-c490-4082-b636-d593bfd1c42b
md"""
##
"""

# ╔═╡ 4baacc73-7d87-4a22-9d66-e05601a1aa81
gg(x,y) = exp(-x^2 - y^2)  # Esto define la funcion de interes

# ╔═╡ a9b2779b-3a64-435b-a869-1bffb8e8aeca
GG = gg.(Xs,Ys);

# ╔═╡ 4273fc0c-a216-4f31-9773-1e097f7c3e77
wireframe(xs, ys, GG)  # Puede ser tambien surface()

# ╔═╡ 4a2f291c-90b9-4d75-954f-edfadb2f19fb
heatmap(xs, ys, GG, aspect_ratio=1)

# ╔═╡ 4909e54d-e25f-4db0-bd99-2b3a948f0dc0
md"""
##
...
# ╔═╡ 8e86774c-806e-4ceb-9614-1a454e6dd147
begin
	tt = -0.2:0.01:1.2
	rx1 = tt
	ry1 = sin.(5tt)
...
# ╔═╡ 4add301e-cf1f-4d66-9843-3b7d5b0ef712
begin
	p7 = wireframe(xs, ys, GG)  # Puede ser tambien surface()
	p7 = plot3d!(rx1, ry1, rz1, linewidth=2, color=:blue, proj_type = :persp, leg=:false) #, camera = (anA,anP)
end

# ╔═╡ 63bb1f54-6847-4261-871e-80f3b74d4e72
md"""
...
# ╔═╡ de3e94ca-7d81-4f92-aae0-b904292bb1fb
savefig(p7,"figura.png")

# ╔═╡ 0df9f628-fcbd-4f7c-ae94-41f63b387291
savefig(p7,"figura.pdf")

# ╔═╡ 1c38bab0-41d2-4152-9059-9c8548043d19
savefig(p7,"figura.svg")

# ╔═╡ a48a5dde-613a-42af-9c51-e538206d9b30
md"""
- Es importante comentar que los formatos soportados dependen del motor para graficar que estemos usando.
"""

# ╔═╡ 34d769b2-c059-42bd-b915-abbe1c71a21d
md"""
## Animaciones

Podemos hacer animaciones utilizando el macro **@gif**
"""

# ╔═╡ d944fccc-e003-4535-b334-24aa2cbe316e
begin
	Nt = 50
	...
	cps = 10
	gif(anim, "animacion_fps15.gif", fps = cps)
end

# ╔═╡ cec12444-c09f-4339-bc9a-4786f618c057
md"""
...
# ╔═╡ 4d132b86-c630-4559-bf2a-01de243a1581
# plotly()

# ╔═╡ cdb55c1a-05cf-4ce0-9a2f-92270769de84
plot(x, y, 
	color=:orange,
	linewidth=4,
	linestyle=:dash,
...
# ╔═╡ 33033a1c-a824-448b-98c0-6d0d782f134d
md"""
##
"""

# ╔═╡ 694ac479-af79-4e38-b0e7-4b1ca7d15007
begin
...
# ╔═╡ aae44b3f-e7b5-48d8-bd65-1c967f46e34b
md"""
##
"""

# ╔═╡ 191f8e9e-ba1d-4243-b924-4ed5d0c734fc
begin
...
# ╔═╡ cf6e392c-4ef5-4af6-826f-c4a53a41fed5
heatmap(xs, ys, GG, aspect_ratio=1)
